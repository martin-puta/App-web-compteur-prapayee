...
const AuthHome = () => {
  ...
  return (
    <>
      <HeadDatas
        title="New client"
        description="smart meter, create new client user"
      />
            ...
            <section className={`${Style.ContainerApp}`}>
              ...
              <section className={`${Style.ContentDatas}`}>
                ...
                <div className={`${Style.NavTitle}`}>
                  <h1>Création des nouveaux comptes Clients</h1>
                  <span className={`${Style.Title}`}>
                    Ajouter des comptes Utilisateur clients
                  </span>
                </div>
